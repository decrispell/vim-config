...
# replace BUILD_DIRECTORY_GOES_HERE with the root build directory if you are using CMake's CMAKE_EXPORT_COMPILE_COMMANDS option
compilation_database_folder = 'BUILD_DIRECTORY_GOES_HERE'
